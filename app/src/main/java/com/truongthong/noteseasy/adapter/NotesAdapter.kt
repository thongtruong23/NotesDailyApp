package com.truongthong.noteseasy.adapter
...
import com.truongthong.noteseasy.R
...
//            holder.itemView.cardView.setCardBackgroundColor(Color.parseColor(R.color.ColorDarkBlack.toString()).toInt())
        }
